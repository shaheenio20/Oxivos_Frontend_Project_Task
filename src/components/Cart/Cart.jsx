    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center bg-base-100 px-4">
        <div className="text-center space-y-6 max-w-md w-full p-8 rounded-2xl bg-base-200/50">
          ...
          <h2 className="text-3xl font-extrabold text-base-content">Your cart is empty</h2>
          <p className="text-base-content/70">Looks like you haven't added anything to your cart yet. Discover our amazing products!</p>
          <Link to="/products" className="btn btn-primary btn-block btn-lg shadow-lg">
            Start Shopping
          </Link>
        </div>
      </div>
      ...
      <div className="w-11/12 lg:w-9/12 mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3 space-y-4">
            {cart.map((item) => (
              <div key={item.id} className="card sm:card-side bg-base-100 border border-base-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="card-body p-6 flex flex-col justify-between">
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      ...
                      <p className="text-sm text-base-content/60 font-medium">{item.category}</p>
                    </div>
                    <p className="font-bold text-xl text-primary shrink-0">${item.price}</p>
                  </div>
          ...
          <div className="lg:w-1/3">
            <div className="card bg-base-200/50 border border-base-300 sticky top-24">
              <div className="card-body p-8">
                <h3 className="text-2xl font-bold mb-6 pb-4 border-b border-base-300">Order Summary</h3>
                ...
                <div className="border-t border-base-300 pt-6 mb-8 flex justify-between items-end">
                  ...
                  <span className="text-3xl font-extrabold text-primary">${(cartTotal * 1.05).toFixed(2)}</span>
                </div>
                ...
                <div className="text-center mt-4">
                  <Link to="/products" className="text-sm font-medium hover:text-primary transition-colors underline-offset-4 hover:underline">
                    Continue Shopping
                  </Link>
                </div>
              </div>
